...
$habiatMap = new ObitanyeMap();
$count = $habiatMap->count();
$habiats = $habiatMap->findAll($page*$size-$size, $size);
$header = 'Список зон обитания';
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <a class="btn btn-success" href="add-obitanie.php">Добавить </a>
